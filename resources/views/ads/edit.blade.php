...
@section('title', 'Modifier l\'annonce : ' . $ad->title)
                    ...
                    <form method="POST" action="{{ route('ads.update', $ad) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="5" required>{{ old('description', $ad->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           id="price" name="price" value="{{ old('price', $ad->price) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            @if($ad->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $ad->image) }}" alt="Image actuelle" 
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('ads.show', $ad) }}" class="btn btn-outline-secondary me-md-2">
                                Annuler
                            </a>
